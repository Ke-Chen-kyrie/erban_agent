...
from rosbags.typesys.stores import ros2_jazzy as _ros2_jazzy_store  # noqa: F401

DEFAULT_FOXGLOVE_BRIDGE_URL = "ws://192.168.217.100:8768"
...
class FoxgloveClient:
    ...
    def __init__(self, url: str = None):
        self._url = url or DEFAULT_FOXGLOVE_BRIDGE_URL
    ...
    async def connect(self, discovery_timeout: float = 3.0):
        ...
        # foxglove-sdk-cpp/v0.25.x 对 websockets 16 的新 asyncio client
        # 握手兼容性不好；legacy client 的请求头更朴素，并禁用压缩扩展。
...
class FoxgloveImageCapture:
    ...
    def _connect_sync(self):
        ...
        if self._sub_id is None:
            logger.error(f"[foxglove] 订阅超时: 话题 '{self._topic}' 15秒内未收到帧")
